...
public interface DataProvider {
   ...
   * @deprecated  use subsequent calls to {@link #getCharAt} or <code>toString</code>
   *              instead
   */
  public char[] getData();
   ...
   * @deprecated  use indexes for {@link #getCharAt} starting with 0 up to 
   *              {@link #getLength} (excluding).
   */
